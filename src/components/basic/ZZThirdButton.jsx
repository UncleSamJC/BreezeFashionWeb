...
function ThirdButton({ to, children, className = '' }) {
  return (
    ...
    >
      {/* 渐变滑块背景 */}
      <span className="absolute left-0 top-0 h-full w-0 group-hover:w-full transition-all duration-500 bg-gradient-to-r from-gray-800 via-slate-700 to-gray-900 opacity-90 z-0"></span>
