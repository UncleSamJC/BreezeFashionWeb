  ...
  return (
    <>
      <SubPageHero
        ...
        title="Legal Insights & Expert Opinions"
        description="Stay informed with the latest legal trends, expert advice, and practical solutions to navigate legal challenges."
        showButtons={true}
      />
      <BlogGrid />
    </>
